...
const initialPosts: SocialPost[] = [
	{
		...
		scheduledTime: "2023-06-20 10:00",
	},
	{
		id: 2,
		platform: "twitter",
		content:
			"Flash sale! 20% off all items for the next 24 hours. #summersale",
		scheduledTime: "2023-06-21 09:00",
	},
	{
		id: 3,
		platform: "instagram",
		content:
			"Behind the scenes look at our latest photoshoot. Stay tuned for the full collection reveal!",
...
export default function SocialMediaPage() {
	...
	const handleSubmit = (e: React.FormEvent) => {
		...
		setPosts((prev) => [
			...prev,
			{ ...newPost, id: Math.max(...prev.map((p) => p.id)) + 1 },
		]);
					...
					<form onSubmit={handleSubmit} className="space-y-4">
						<div>
							...
							<select
								...
								onChange={
									handlePostChange as React.ChangeEventHandler<HTMLSelectElement>
								}
