          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <FileUploader
                id="logo"
                accept="image/*"
                onFileSelect={(file) => setSettings(prev => ({ ...prev, logo: URL.createObjectURL(file) }))}
              />
              {settings.logo && <img src={settings.logo} alt="Store Logo" className="mt-2 h-20 w-20 object-contain" />}
            </div>
            <div>
              ...
              <FileUploader
                id="banner"
                accept="image/*"
                onFileSelect={(file) => setSettings(prev => ({ ...prev, banner: URL.createObjectURL(file) }))}
              />
              {settings.banner && <img src={settings.banner} alt="Store Banner" className="mt-2 h-40 w-full object-cover" />}
            </div>
            <div>
            ...
            <div className="flex items-center space-x-2">
              <Switch id="isPublished" checked={settings.isPublished} onCheckedChange={handleTogglePublish} />
            ...
            <div className="flex items-center space-x-2">
              <Switch
                ...
                onCheckedChange={(checked) => setSettings(prev => ({ ...prev, isBoosted: checked }))}
              />
